...
export const updateContent = createAsyncThunk(
  ...
  async (args, thunkApi) => {
    console.log(args.values.665a3df50d562a4b1c3c3db3);
    try {
      const { data } = await axios.put(
        `http://localhost:8000/api/v1/subcategory/${args.values.id}`,{
          title:args.values.title,
          subtitle:args.values.subtitle,
          image:args.values.image[0],
          logo:args.values.logo[0]
        }
