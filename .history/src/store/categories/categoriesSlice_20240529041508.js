...
export const getCategories = createAsyncThunk(
  ...
  async (args, thunkApi) => {
    try {
      ...
      const { data } = await axios.get(`/categories?page=${page}&size=${size}&search=${search}${filter}`);
...
export const createCategory = createAsyncThunk(
  "http://localhost:8000/v1/c",
  async (args, thunkApi) => {
    try {
      const { data } = await axios.post("/categories", args);
      return thunkApi.fulfillWithValue(data);
    } catch (e) {
      return thunkApi.rejectWithValue(e.response.data);
    }
...
export const updateCategory = createAsyncThunk(
  ...
  async (args, thunkApi) => {
    try {
      const { data } = await axios.put(`/categories/${args.id}`, args.values);
      return thunkApi.fulfillWithValue(data);
    } catch (e) {
      return thunkApi.rejectWithValue(e.response.data);
    }
...
export const deleteCategory = createAsyncThunk(
  ...
  async (args, thunkApi) => {
    try {
      const { data } = await axios.delete(`/categories/${args.id}`);
      return thunkApi.fulfillWithValue(data);
    } catch (e) {
      return thunkApi.rejectWithValue(e.response.data);
    }
