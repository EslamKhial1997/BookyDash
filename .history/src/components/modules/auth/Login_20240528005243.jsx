...
const Login = () => {
  ...
  return (
    <AuthWarpper>
      <Flex
        background={`url(${authBg}) no-repeat`} backgroundSize="cover" minH="100vh"
      ...
      >
        <Box bg={theme.light} padding={8} className="auth-box" borderRadius={2}>
          ...
          <Box textAlign="center" pt={4}>
            <Heading
              color={theme.dark} fontSize={22} textTransform="capitalize" mb={2}
            >
              {t('pages.auth.welcome_1')}
            </Heading>

            <Text
              color={theme.gary1} fontSize={16} textTransform="capitalize" mb={4}
            >
          ...
          <form onSubmit={handleSubmit(values => {
            ...
            <Stack spacing={4}>
              ...
              <FormControl>
                ...
                <Input
                  type="email" placeholder={t('pages.auth.email')}
                  border="none" color={theme.dark} bg={theme.body}
              ...
              <FormControl>
                ...
                <InputGroup>
                  <Input
                    type={isPasswordShown ? 'text' : 'password'} placeholder={t('pages.auth.pwd')}
                    border="none" color={theme.dark} bg={theme.body} autoComplete="false"
                    _placeholder={{ color: theme.text }} paddingInline={4}
                    {...register('password', {
                      required: `${t('validation.required')}`,
                      minLength: {
              ...
              <Button
                ...
                borderRadius={2} _hover={{ bg: theme.primary }}
