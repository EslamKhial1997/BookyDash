            ...
            <Stack spacing={6}>
              <FormControl>
                <FormLabel fontWeight="bold" textTransform="capitalize" color="white">
                  {t('pages.challenges.subcategory')}
                </FormLabel>
                <Search
                  page={categoriesPage}
              ...
              <FormControl>
                ...
                <Input type="text" bg={theme.body} color={theme.dark} border="none" borderRadius={2}
                  placeholder={t('pages.challenges.title')} _placeholder={{ textTransform: 'capitalize' }}
                  {...register("name", {
