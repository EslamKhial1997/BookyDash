    ...
    <>
      ...
      >
        ...
        <Flex marginBlock={3} justifyContent="flex-end">
          <InputSearch isLoading={categories.isLoading} onSearch={(s) => setSearch(s)} />
        </Flex>
      </SimpleGrid>
      ...
      {categories.data.length > 0 ? (
        <Table
          ...
          page={page}
          handleUpdate={(el) => setShowUpdateCategory(el._id)}
          handleDelete={(el) => setShowDeleteCategory(el._id)}
        />
      ) : (
        <NoData />
      )}
