    ...
    <Modal isOpen={true} onClose={onClose} size="md">
      ...
      <ModalContent borderRadius={2} paddingBlock={4} bg={theme.dark}>
        <form onSubmit={handleSubmit(values => {
          dispatch(updateCategory({ id: values.id, values }))
            .unwrap()
            .then(res => {
              onClose();
            ...
            <Stack spacing={6}>
              <FormControl>
                ...
                <Input type="text" bg={theme.body} color={theme.dark} border="none" borderRadius={2}
                  placeholder={t('pages.categories.name')} _placeholder={{ textTransform: 'capitalize' }}
                  {...register("name", {
              ...
              <FormControl>
                ...
                <Textarea bg={theme.body} color={theme.dark} border="none" borderRadius={2}
                  placeholder={t('pages.categories.description')} _placeholder={{ textTransform: 'capitalize' }}
