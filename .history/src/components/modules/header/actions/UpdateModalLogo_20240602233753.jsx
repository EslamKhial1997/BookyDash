...
import {  updateHeaderImage, updateHeaderLogo } from "@/store/header/headerSlice";
import { useParams } from "react-router-dom";

const UpdateModalLogo = ({ data, onClose }) => {
      ...
      <ModalContent borderRadius={2} paddingBlock={4} bg={theme.dark}>
        <form
          onSubmit={handleSubmit((values) => {
            dispatch(updateHeaderLogo({ data: values, id: params , type:data }))
              .unwrap()
              .then((res) => {
                // onClose();
...
export default UpdateModalLogo;
