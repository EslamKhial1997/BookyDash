  ...
  async (args, thunkApi) => {
    ...
    try {
      const { data } = await axios.get(
        `https://bookyin.onrender.com/api/v1/subcategory/${args}`
      );
  ...
  async (args, thunkApi) => {
    ...
    try {
      const { data } = await axios.post(
        `https://bookyin.onrender.com/api/v1/category/${args.id}/subcategory`,
        {
  ...
  async (args, thunkApi) => {
    try {
      const { data } = await axios.put(
        `https://bookyin.onrender.com/api/v1/subcategory/${args.id}`,
        {
          title: args.values.title,
        },
        {
